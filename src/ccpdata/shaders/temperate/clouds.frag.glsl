...
void main() {
  ...
  r0.xy = r0.yz*time;
  r0.xy = fract(r0.xy);
  r1 = CloudsFactors.wwww*v0;
  r0.xy = r1.xy*c3.xy+r0.xy;
  r1 = texture2D(CloudCapTexture, r1.zw);
  r0 = texture2D(CloudsTexture, r0.xy);
  r2.x = max(r0.x, r1.x);
  r0.x = pow(abs(r2.x), CloudsFactors.z);
  ...
  r1 = texture2D(GroundScattering2, vec2(r1.x, 1.0-r1.y));
  r0.yzw = r2.xyz+AmbientColor.xyz;
  r2.y = CloudsFactors.y;
  r2.xyz = r2.yyy*CloudsColor.xyz;
