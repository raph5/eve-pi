...
vec4 g2l(vec4 x){return vec4(pow(x.xyz,vec3(2.2)),x.w);}
...
r1.y=saturate(cb7[5].x*r1.z+(-r1.y));
r2.xzw=r5.xxx*cb7[6].xyz;
r3.xyz=r5.yyy*cb7[7].xyz+(-r2.xzw);
r1.yzw=r1.yyy*r3.xyz+r2.xzw;
r2.xzw=r5.zzz*cb7[8].xyz+(-r1.yzw);
r3.x=cb7[11].z+cb7[11].x;
r3.x=(-r3.x)+c19.y;
r3.x=r0.z+(-r3.x);
r3.x=saturate(r3.x*cb7[5].y);
r1.yzw=r3.xxx*r2.xzw+r1.yzw;
r2.xzw=r5.www*cb7[9].xyz+(-r1.yzw);
r2.y=r2.y+(-cb7[11].z);
r2.y=r0.z+(-r2.y);
r0.z=r0.z+cb7[5].w;
r0.z=r0.z+(-cb7[1].x);
...
r4=texture2D(s5,r3.xw);
r5=texture2D(s6,r3.xw);
