export default (function(ccpwgl_int)
{
    ...
    function Camera(element)
    {
        ...
        this._DragMove = function (event)
        {
            ...
            {
                var dRotation = (-(this._dragX - event.screenX) * 1e-8 * this.rotationSpeed) * this.distance;
                this.rotationX += dRotation;
                this._dragX = event.screenX; 
                dRotation = (-(this._dragY - event.screenY) * 1e-8 * this.rotationSpeed) * this.distance;
    ...
    ccpwgl.createCamera = function (canvas, options, setAsCurrent)
    {
        ...
        camera.rotationSpeed = get(options, 'rotationSpeed', 1);
