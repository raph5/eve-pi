...
// shaders
import fragmentShader from '@ccpdata/shaders/plasma/globe.frag.glsl?raw'
import vertexShader from '@ccpdata/shaders/plasma/globe.vert.glsl?raw'

// ccp data
import planetSphere from '@ccpdata/models/planetSphere.json'

export default class GlobePlasma extends PlanetMesh {
